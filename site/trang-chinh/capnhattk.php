                ...
                <div class="chi-tiet">
                    ...
                    <div class="ho-so-ca-nhan">
                        ...
                        <label>Họ tên</label>
                         ...
                         <input type="text" name="ho_va_ten" value="<?=$ho_va_ten?>" id="">
                         <label>Email</label>
                         <input type="text" name="email" value="<?=$email?>" id=""><br>
                         <label>SĐT</label>
                         <input type="text" name="sdt" value="<?=$sdt?>" id="">
                        ...
                        <div class="avt-ct">
                            ...
                            <input style="color: black;" type="file" name="anh_dd"  id="">
                            <input style="color: black;" type="hidden" name="anh" value="<?=$anh_dd?>" id="">
                        </div>
                    </div>
                </div>
                </form>
